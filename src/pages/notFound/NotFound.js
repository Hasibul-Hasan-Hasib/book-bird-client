...
import image from '../../assets/image/heroImg/404 Error-rafiki.svg';
...
export default function NotFoundImage() {
    ...
    return (
        <Container size='md' className={classes.root}>
            <SimpleGrid spacing={80} cols={2} breakpoints={[{ maxWidth: 'sm', cols: 1, spacing: 40 }]} style={{ alignItems: 'center' }}>
