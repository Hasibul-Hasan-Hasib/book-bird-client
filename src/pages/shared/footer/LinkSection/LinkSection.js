    ...
    return (
        <>
            <div className={styles.background}>
                <Container size='lg' className={styles.firstSectionContainer}>
                ...
                <hr />
                <Container size='lg'>
                    <Grid columns={12} className={styles.secondSectionContainer}>
                        <Grid.Col xs={12} md={2} className={styles.linksContainer}>
                        ...
                        <Grid.Col xs={12} md={3} className={styles.linksContainer}>
